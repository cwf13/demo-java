;(function () {
    ...
    var EasyEditor = function (id) {
        ...
        this.insertEmoji = function (opts) {
            ...
            // t.insertHTML('<img id="easy-editor-save" class="easy-emoji" src="'+opts.src+'" contenteditable="false"/>');
            // t=insertHTML('<img id="easy-editor-save" class="easy-emoji" src="'+opts.src+'" contenteditable="false"/>');
            $(".showEmoji .layui-m-layercont .inVaule").append('<img id="easy-editor-save" class="easy-emoji" src="' + opts.src + '" contenteditable="false"/>')
