...
public class ZaUsers {
    ...
    private String parusers;

    private String clubids;

    private Long topClub;
    ...
    public String getParusers() {
        return parusers;
    }

    public void setParusers(String parusers) {
        this.parusers = parusers == null ? null : parusers.trim();
    }
    ...
    public Long getTopClub() {
        return topClub;
    }

    public void setTopClub(Long topClub) {
        this.topClub = topClub;
    }
